            ...
            <div class="md:flex w-full">
                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div class="text-center mb-10">
                        <h1 class="font-bold text-3xl text-gray-900">Администратор</h1>
                        <p></p>
                    </div>
                    <div>
<!--                        <div class="flex -mx-3">-->
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="email" v-model="admin.email" class="w-full -ml-10 pl-3 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="artemivanets@example.com">

                                </div>
                                <ValidationComponent name="email"  v-model="admin.email"></ValidationComponent>
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-12">
                                ...
                                <div class="unique-password-style w-full">
                                    <Password class="w-full" style="width:100%" placeholder="*****************" :feedback="false"  toggleMask  v-model="admin.password">
                                    </Password>
                                </div>
                                <ValidationComponent name="password"   v-model="admin.password"></ValidationComponent>

                            </div>
                        </div>
                        <div class="flex-col justify-center unique-footer-style -mx-3">
                            <div class="w-full px-4 mb-5">
                                <button class="block w-full max-w-xs mx-auto bg-indigo-500  hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-4 py-4 font-semibold" @click="login">Войти как администратор</button>
                            </div>
                            <div class="w-full px-4 mb-5">
...
const admin = ref({})
const adminState = computed(()=>store.getters['authAdmin/adminState']);

const login = ()=>{
    store.dispatch('authAdmin/loginAdmin', admin.value);
    setTimeout(()=>{
        if(adminState.value == false)
        {
            toast.add({
                severity:'warn',
