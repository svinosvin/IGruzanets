                        ...
                        <div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="email" v-model="user.email" class="w-full -ml-10 pl-3 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="artemivanets@example.com">
                            ...
                            <div class="flex-col justify-center unique-footer-style -mx-3">
                                <div class="w-full px-4 mb-5">
                                    <button class="block w-full max-w-xs mx-auto bg-indigo-500  hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-4 py-4 font-semibold" @click="login">Войти</button>
                                </div>
                                <div class="w-full px-4 mb-5">
                                    <router-link to="/register"> <p class="text-center font-bold"> <a href="#">
                                        <button class="block w-full max-w-xs mx-auto bg-pink-300  hover:bg-pink-700 focus:bg-indigo-700 text-white rounded-lg px-4 py-4 font-semibold">Перейти к регистрации</button>
                                    </a></p> </router-link>
