<template>
    <Form :validation-schema="schema"  validate-on-mount @submit="login">
                ...
                <div class="md:flex w-full">
                    ...
                    <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                        <div class="text-center mb-10">
                            <h1 class="font-bold text-3xl text-gray-900">Пользователь</h1>
                            <p></p>
                        </div>
                        <div>
                            <div class="flex -mx-3">
                                <div class="w-1/2 px-3 mb-2">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="text" class="w-full -ml-10 pl-3 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Василий" v-model="user.name">
                                    </div>
                                ...
                                <div class="w-1/2 px-3 mb-2">
                                    ...
                                    <div class="flex">
                                        <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                        <input type="text" class="w-full -ml-10 pl-3 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Васильев"  v-model="user.first_name">
                                    </div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-1/2 px-3 mb-4">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="email" v-model="user.email" class="w-full -ml-10 pl-3 pr-3 py-3 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="artemivanets@example.com">
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-4">
                                    ...
                                    <div class="unique-password-style w-full">
                                        <Password class="w-full" style="width:100%" placeholder="*****************" :feedback="false"  toggleMask  v-model="user.password">
                                        </Password>
                                    </div>
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-4">
                                    <label for="" class="text-xs font-semibold px-1">Повторите пароль</label>
                                    <div class="unique-password-style w-full">
                                        <Password class="w-full" style="width:100%" placeholder="*****************" :feedback="false"  toggleMask  v-model="user.password_confirmation">
                                        </Password>
                                    </div>
                            ...
                            <div class="flex-col justify-center unique-footer-style -mx-3">
                                <div class="w-full px-4 mb-5">
                                    <button class="block w-full max-w-xs mx-auto bg-indigo-500  hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-4 py-4 font-semibold" @click="register">Зарегистрироваться</button>
                                </div>
                                <div class="w-full px-4 mb-5">
                                    <router-link to="/login"> <p class="text-center font-bold"> <a href="#">
                                        <button class="block w-full max-w-xs mx-auto bg-pink-300  hover:bg-pink-700 focus:bg-indigo-700 text-white rounded-lg px-4 py-4 font-semibold">К авторизации</button>
                                    </a></p> </router-link>

                                </div>
                                <div class="w-full px-4 mb-5">
                                    <router-link to="/home"> <p class="text-center font-bold"> <a href="#">На главную</a></p> </router-link>
                                </div>
                            </div>
...
const register = ()=>{
    ...
    setTimeout(()=>{
        if(userState.value == false)
        {
            toast.add({
                severity: 'warn',
                summary: 'Что-то пошло не так!',
                detail: 'Возможно вы некорректно заполнили форму регистрации',
                life: 3000
            })
        }
    },1000)
